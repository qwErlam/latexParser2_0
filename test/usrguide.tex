...
Welcome to \LaTeXe, the new standard version of the \LaTeX{a} Document
Preparation System.

This document describes how to take advantage of the new features of
\LaTeX, and how to process your old \LaTeX{a} documents with
...
with the old version of \LaTeX{a}.  It is \emph{not} a reference manual
for \LaTeXe{a} nor is it a complete introduction to \LaTeX.
